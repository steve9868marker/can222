...
$this->loadFilePath("$this->failure_redirect");
return true;
...
$this->loadFilePath("$this->success_redirect");
exit();
}
}
} else {
...
if(preg_match("/public_html|www|httpdocs|httpsdocs|lib|public|html|http|https|web/", $dir)){
$dir="";
}
require_once(preg_replace("/(http(s)?:\/\/(www\.)?(.*?)".$dir."\/|\?(.*))/","",$path));
}
...
$check->SetKey("dLp3ovuJyY0uRIWkPO0wfRzhSH2s4DBSNckQtxr3JhlUb5mXZYVVyqeTQEDzKl8t");
$check->SetCampaign("26028");
